...
DIR_NAME="EVAL_nslkdd_10P_GAUSS"
TRAIN_DAT="train_nslkdd_10p.dat"
TEST_DAT="test_nslkdd_10p.dat"
...
do
    ...
    ${CMAKE_CURRENT_BINARY_DIR}/femafs 2 0.10 $FEMA_TRAIN $FEMA_TEST END=9.0 &> result_femafs
...
do
    ...
    cat iteration_$i/result_opffemafs_final >> $RESULT_OPF_FEMA_FEMA
done
cd ${CMAKE_CURRENT_BINARY_DIR}
