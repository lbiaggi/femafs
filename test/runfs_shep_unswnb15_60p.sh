...
DIR_NAME="EVAL_UNSWNB15_60P_SHEP"
...
do
    ...
    # ${CMAKE_CURRENT_BINARY_DIR}/femafs 0 0.60 ${FEMA_TRAIN} ${FEMA_TEST} 6.0 2> result_femafs
    ...
    ../../femafs 0 0.60 "${FEMA_TRAIN}" "${FEMA_TEST}" 6.0 &> result_femafs
