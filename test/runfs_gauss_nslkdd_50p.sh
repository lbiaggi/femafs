...
DIR_NAME="EVAL_nslkdd_50P_GAUSS"
TRAIN_DAT="train_nslkdd_50p.dat"
TEST_DAT="test_nslkdd_50p.dat"
...
do
    ...
    ${CMAKE_CURRENT_BINARY_DIR}/femafs 2 0.50 $FEMA_TRAIN $FEMA_TEST END=9.0 &> result_femafs
