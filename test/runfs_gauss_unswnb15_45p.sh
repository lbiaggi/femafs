...
DIR_NAME="EVAL_UNSWNB15_45P_GAUSS"
TRAIN_DAT="train_unswnb15_45p.dat"
TEST_DAT="test_unswnb15_45p.dat"
...
do
    ...
    # ${CMAKE_CURRENT_BINARY_DIR}/femafs 2 0.45 ${FEMA_TRAIN} ${FEMA_TEST} 9.0 2> result_femafs
    ...
    ../../femafs 2 0.45 "${FEMA_TRAIN}" "${FEMA_TEST}" 9.0 &> result_femafs
