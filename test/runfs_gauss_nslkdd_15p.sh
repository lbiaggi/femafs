...
DIR_NAME="EVAL_nslkdd_15P_GAUSS"
TRAIN_DAT="train_nslkdd_15p.dat"
TEST_DAT="test_nslkdd_15p.dat"
...
do
    ...
    ${CMAKE_CURRENT_BINARY_DIR}/femafs 2 0.15 $FEMA_TRAIN $FEMA_TEST END=9.0 &>> result_femafs
