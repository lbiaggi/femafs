...
DIR_NAME="EVAL_tornontor_45P_SHEP"
TRAIN_DAT="train_tor-nontor_45p.dat"
TEST_DAT="test_tor-nontor_45p.dat"
...
do
    ...
    ${CMAKE_CURRENT_BINARY_DIR}/femafs 0 0.45 ${FEMA_TRAIN} ${FEMA_TEST} 6.0 &> result_femafs
