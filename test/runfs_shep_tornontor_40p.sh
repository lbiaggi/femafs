...
DIR_NAME="EVAL_tornontor_40P_SHEP"
TRAIN_DAT="train_tor-nontor_40p.dat"
TEST_DAT="test_tor-nontor_40p.dat"
...
do
    ...
    ${CMAKE_CURRENT_BINARY_DIR}/femafs 0 0.40 ${FEMA_TRAIN} ${FEMA_TEST} 6.0 &> result_femafs
