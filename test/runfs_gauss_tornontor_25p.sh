...
DIR_NAME="EVAL_tornontor_25P_GAUSS"
TRAIN_DAT="train_tor-nontor_25p.dat"
TEST_DAT="test_tor-nontor_25p.dat"
...
do
    ...
    ${CMAKE_CURRENT_BINARY_DIR}/femafs &> 0.25 ${FEMA_TRAIN} ${FEMA_TEST} 9.0 &>> result_femafs
