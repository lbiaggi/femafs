...
DIR_NAME="EVAL_nslkdd_60P_SHEP"
TRAIN_DAT="train_nslkdd_60p.dat"
TEST_DAT="test_nslkdd_60p.dat"
...
OPF_TEST="test-nslkdd.opf"
OPF_TRAIN="train-nslkdd.opf"
for i in $(seq 1 $END);
do
    echo -e "Testing N: $i\n"
    ...
    echo -e "Preprocessing for test N: $i\n"
     python "${CMAKE_CURRENT_BINARY_DIR}/preprocessing_nslkdd.py" -ta "${CMAKE_CURRENT_BINARY_DIR}/unswnb60/nslkdd-train.txt" -te "${CMAKE_CURRENT_BINARY_DIR}/unswnb60/nslkdd-testing.txt"
