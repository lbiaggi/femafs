...
DIR_NAME="EVAL_tornontor_55P_GAUSS"
TRAIN_DAT="train_tor-nontor_55p.dat"
TEST_DAT="test_tor-nontor_55p.dat"
...
do
    ...
    ${CMAKE_CURRENT_BINARY_DIR}/femafs &> 0.55 ${FEMA_TRAIN} ${FEMA_TEST} 9.0 &> result_femafs
