...
DIR_NAME="EVAL_UNSWNB15_15P_GAUSS"
TRAIN_DAT="train_unswnb15_15p.dat"
TEST_DAT="test_unswnb15_15p.dat"
...
do
    ...
    # ${CMAKE_CURRENT_BINARY_DIR}/femafs 2 0.15 ${FEMA_TRAIN} ${FEMA_TEST} 9.0 2> result_femafs
    ...
    ../../femafs 2 0.15 "${FEMA_TRAIN}" "${FEMA_TEST}" 9.0 &> result_femafs
