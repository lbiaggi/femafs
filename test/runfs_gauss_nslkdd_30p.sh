...
DIR_NAME="EVAL_nslkdd_30P_GAUSS"
TRAIN_DAT="train_nslkdd_30p.dat"
TEST_DAT="test_nslkdd_30p.dat"
...
do
    ...
    ${CMAKE_CURRENT_BINARY_DIR}/femafs 2 0.30 $FEMA_TRAIN $FEMA_TEST END=9.0 &> result_femafs
