...
DIR_NAME="EVAL_UNSWNB15_15P_SHEP"
...
do
    ...
    # ${CMAKE_CURRENT_BINARY_DIR}/femafs 0 0.15 ${FEMA_TRAIN} ${FEMA_TEST} 6.0 2> result_femafs
    ...
    ../../femafs 0 0.15 "${FEMA_TRAIN}" "${FEMA_TEST}" 6.0 &> result_femafs
