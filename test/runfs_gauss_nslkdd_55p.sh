...
DIR_NAME="EVAL_nslkdd_55P_GAUSS"
TRAIN_DAT="train_nslkdd_55p.dat"
TEST_DAT="test_nslkdd_55p.dat"
...
do
    ...
    ${CMAKE_CURRENT_BINARY_DIR}/femafs 2 0.55 $FEMA_TRAIN $FEMA_TEST END=9.0 &> result_femafs
