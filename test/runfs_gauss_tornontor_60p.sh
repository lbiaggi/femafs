...
DIR_NAME="EVAL_tornontor_60P_GAUSS"
TRAIN_DAT="train_tor-nontor_60p.dat"
TEST_DAT="test_tor-nontor_60p.dat"
...
do
    ...
    python "${CMAKE_CURRENT_BINARY_DIR}/preprocessing_tor-nontor.py" -ta "${CMAKE_CURRENT_BINARY_DIR}/unswnb60/tor-nontor-train.txt" -te "${CMAKE_CURRENT_BINARY_DIR}/unswnb60/UNSW_NB15_testing-set.csv"
    echo -e "Feature selection with fema  for test N: ${i}\n"
    ${CMAKE_CURRENT_BINARY_DIR}/femafs &> 0.60 ${FEMA_TRAIN} ${FEMA_TEST} 9.0 &> result_femafs
