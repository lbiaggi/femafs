...
do
    ...
    mkdir "$TEST_DIR"
    cd "$TEST_DIR"
    # python "preprocessing_unswnb15.py" -ta "${CMAKE_CURRENT_BINARY_DIR}/unswnb60/UNSW_NB15_training-set.csv" -te "${CMAKE_CURRENT_BINARY_DIR}/unswnb60/UNSW_NB15_testing-set.csv"
