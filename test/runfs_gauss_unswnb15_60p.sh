...
DIR_NAME="EVAL_UNSWNB15_60P_GAUSS"
TRAIN_DAT="train_unswnb15_60p.dat"
TEST_DAT="test_unswnb15_60p.dat"
...
do
    ...
    mkdir "$TEST_DIR"
    cd "$TEST_DIR"
    # python "${CMAKE_CURRENT_BINARY_DIR}/preprocessing_unswnb15.py" -ta "${CMAKE_CURRENT_BINARY_DIR}/unswnb60/UNSW_NB15_training-set.csv" -te "${CMAKE_CURRENT_BINARY_DIR}/unswnb60/UNSW_NB15_testing-set.csv"
    # ${CMAKE_CURRENT_BINARY_DIR}/femafs 2 0.60 ${FEMA_TRAIN} ${FEMA_TEST} 9.0 2> result_femafs
    ...
    ../../femafs 2 0.60 "${FEMA_TRAIN}" "${FEMA_TEST}" 9.0 &> result_femafs
