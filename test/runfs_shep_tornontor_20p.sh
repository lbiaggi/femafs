...
DIR_NAME="EVAL_tornontor_20P_SHEP"
TRAIN_DAT="train_tor-nontor_20p.dat"
TEST_DAT="test_tor-nontor_20p.dat"
...
do
    ...
    python "${CMAKE_CURRENT_BINARY_DIR}/preprocessing_tor-nontor.py" -ta "${CMAKE_CURRENT_BINARY_DIR}/data/tor-nontor/tor-nontor-train.txt" -te "${CMAKE_CURRENT_BINARY_DIR}/data/tor-nontor/UNSW_NB15_testing-set.csv"
    echo -e "Feature selection with fema  for test N: ${i}\n"
    ${CMAKE_CURRENT_BINARY_DIR}/femafs 0 0.20 ${FEMA_TRAIN} ${FEMA_TEST} 6.0 &> result_femafs
