...
DIR_NAME="EVAL_UNSWNB15_55P_GAUSS"
TRAIN_DAT="train_unswnb15_55p.dat"
TEST_DAT="test_unswnb15_55p.dat"
...
do
    ...
    # ${CMAKE_CURRENT_BINARY_DIR}/femafs 2 0.55 ${FEMA_TRAIN} ${FEMA_TEST} 9.0 2> result_femafs
    ...
    ../../femafs 2 0.55 "${FEMA_TRAIN}" "${FEMA_TEST}" 9.0 &> result_femafs
