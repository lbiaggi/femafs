...
DIR_NAME="EVAL_tornontor_15P_SHEP"
TRAIN_DAT="train_tor-nontor_15p.dat"
TEST_DAT="test_tor-nontor_15p.dat"
...
do
    ...
    ${CMAKE_CURRENT_BINARY_DIR}/femafs 0 0.15 ${FEMA_TRAIN} ${FEMA_TEST} 6.0 &>> result_femafs
