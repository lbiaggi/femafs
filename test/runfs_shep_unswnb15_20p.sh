...
DIR_NAME="EVAL_UNSWNB15_20P_SHEP"
TRAIN_DAT="train_unswnb15_20p.dat"
TEST_DAT="test_unswnb15_20p.dat"
...
do
    ...
    # ${CMAKE_CURRENT_BINARY_DIR}/femafs 0 0.20 ${FEMA_TRAIN} ${FEMA_TEST} 6.0 2> result_femafs
    ...
    ../../femafs 0 0.20 "${FEMA_TRAIN}" "${FEMA_TEST}" 6.0 &> result_femafs
