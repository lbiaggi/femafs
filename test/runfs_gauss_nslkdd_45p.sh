...
DIR_NAME="EVAL_nslkdd_45P_GAUSS"
TRAIN_DAT="train_nslkdd_45p.dat"
TEST_DAT="test_nslkdd_45p.dat"
...
do
    ...
    ${CMAKE_CURRENT_BINARY_DIR}/femafs 2 0.45 $FEMA_TRAIN $FEMA_TEST END=9.0 &> result_femafs
