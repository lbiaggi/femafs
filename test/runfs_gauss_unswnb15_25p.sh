...
DIR_NAME="EVAL_UNSWNB15_25P_GAUSS"
...
do
    ...
    # ${CMAKE_CURRENT_BINARY_DIR}/femafs 2 0.25 ${FEMA_TRAIN} ${FEMA_TEST} 9.0 2> result_femafs
    ...
    ../../femafs 2 0.25 "${FEMA_TRAIN}" "${FEMA_TEST}" 9.0 &> result_femafs
