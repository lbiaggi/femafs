...
DIR_NAME="EVAL_nslkdd_40P_GAUSS"
TRAIN_DAT="train_nslkdd_40p.dat"
TEST_DAT="test_nslkdd_40p.dat"
...
do
    ...
    ${CMAKE_CURRENT_BINARY_DIR}/femafs 2 0.40 $FEMA_TRAIN $FEMA_TEST END=9.0 &> result_femafs
